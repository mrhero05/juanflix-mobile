...
export default () => {
	...
	const login = async () => {
		try {
			const loginDetails = { user: 'test', password:'test1234' };
			console.log('test');
			const response = await LoginService.login(loginDetails);
			console.log(response, "%o test response");
		} catch (error) {
		...
		<SafeAreaView>
			<ScrollView>
				<View className="flex-1 justify-center items-center w-full">
					...
					<Text className="text-red-300">{API_URL}</Text>
					<Text className="text-red-300">{API_TOKEN}</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test asdf</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
					<Text className="text-red-300">Test Tailwind</Text>
